export default {
    ...
    basename: '/data-able/react/default', // only at build time to set, like /datta-able
    layout: 'vertical', // vertical, horizontal (not available in lite version)
    preLayout: '', // (not available in lite version)
    ...
    layout6Background : 'linear-gradient( #23b7e5 100%, #23b7e5 100%)', // used only for pre-layout = layout-6
