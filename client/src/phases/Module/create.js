...
class Create extends Component{
    ...
    postDataHandler = ()=>{
        if(this.state.formIsValid){
            const data = {
                module: this.state.createmoduleForm.module.value,
                description:this.state.description        
            }
    
            axios.post('/api/module/create',data)
                .then(res => {
                    console.log(res);
                });
    ...
    inputChangeHandler = (event, elementIdentifier) => {
        ...
        const updateForm = {...this.state.createmoduleForm};
        ...
        this.setState({createmoduleForm: updateForm});
    ...
    render(){
        ...
        for (let key in this.state.createmoduleForm){
            formElementsArray.push({
                id: key,
                config: this.state.createmoduleForm[key]
            });
        }
        const styles = {
            color:"red"
